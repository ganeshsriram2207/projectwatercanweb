...
public class HomePage {
	...
	public static void homepage() throws SQLException, DBException {
		...
		try {
			...
			if (selection.equals("register")) {
				...
				//user.register(name, mobilenumber, password, Emailid);
	...
	public int QualityCheck() throws InputMismatchException, SQLException, DBException {
		boolean test = false;
		int choice = 0;
		while (test != true) {
			try {
	...
	public void WelcomePage() throws SQLException, InputMismatchException, DBException {
	...
	public static void main(String[] args) throws SQLException, InputMismatchException, DBException {
		HomePage hp = new HomePage();
		hp.WelcomePage();
